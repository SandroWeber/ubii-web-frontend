export const WEB_GL_MOUSE_SPHERE_NAME = "webGLMouseSphere";
export const CSS3D_MOUSE_SPHERE_NAME = "css3DMouseSphere";
export const WEBSITE_CANVAS_NAME_PREFIX = "WebsiteCanvas";
