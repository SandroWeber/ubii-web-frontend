 ...
 * 
 * Notes: https: //stackoverflow.com/questions/47944038/difference-between-objloader-and-objloader2-in-three-js
 */
...
OBJLoader2.prototype = {
	...
	load: function (url, onLoad, onProgress, onError, onMeshAlter, useAsync) {
		var resource = new ResourceDescriptor(url, 'OBJ');
	 ...
	 *
	 * @param {PrepData} prepData All parameters and resources required for execution
	 * @param {WorkerSupport} [workerSupportExternal] Use pre-existing WorkerSupport
	 */
	...
	loadMtl: function (url, content, onLoad, onProgress, onError, crossOrigin, materialOptions) {
		var resource = new ResourceDescriptor(url, 'MTL');
