  ...
  <div>
    ...
    <div class="category">
      ...
      <div class="grid">
        ...
        <router-link to="/applications/smartphone-assisted-vr/savr-model-inspector" class="interface-link" tag="div">
          <app-tile class="layer-three background round shadow orange-accent">
...
<script>
  ...
  import { faMousePointer, faCube, faCubes, faVrCardboard, faMobileAlt, faTabletAlt, faKeyboard } from '@fortawesome/free-solid-svg-icons'
